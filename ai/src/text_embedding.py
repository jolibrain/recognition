...
class TextEmbedding(FeatureGenerator):
    ...
    def __init__(self,json_files,model_repo,model_file,index_repo,tate=True,img_files=[],reuters_json=False,meta_in='',meta_out='',captions_in='',captions_out='',mapi_in='',mapi_out=''):
        self.name = 'txtembed'
